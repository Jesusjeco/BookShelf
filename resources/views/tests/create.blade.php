...
<div class="container mx-auto py-8">
    <div class="grid lg:grid-cols-3">
        ...
        <div class="col-span-2 bg-white shadow rounded-lg overflow-hidden">
            <form action="{{route('tests.store')}}" method="POST" novalidate>
                ...
                <div class="bg-gray-100 flex items-center justify-between px-4 py-5 space-x-3">
                    ...
                    <button class="px-6 py-1.5 border-lg bg-blue-500 text-blue-50 font-semibold rounded hover:bg-blue-700">Create Test </button>
                </div>
            </form>
        </div>
    </div>
